  ...
  <img class = "rounded float-left "  src="./assets/images/avl_logo.png">
    ...
    <?php if(isset($_SESSION['UserData']['Username'])):?>
      ...
      <form action="" name="dateForm" method="GET">
        ...
        <label>&nbsp;From:</label><input class="" type="date" id="myFromDate" name="myFromDate" value="<?php echo $myFromDate;?>"/>
        <label>To:</label><input class="" type="date" id="myToDate" name="myToDate" value="<?php echo $myToDate;?>"/>
        <button class="btn btn-primary" type="submit" name="dateFilter">Go</button>
    </div>
    </form>
<h1>
        <?php else: ?>
