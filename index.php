  ...
  <img class="rounded float-left "  src="./assets/images/logo.png">
    ...
    <?php if(isset($_SESSION['UserData']['Username'])):?>
      ...
      <form action="" name="dateForm" method="GET">
        ...
        <button class="btn btn-primary" type="submit" name="myFilters" value="1">Go</button>
    </div>
    </form>
<h1>
        <?php else: ?>
   ...
   <?php endif; ?>
    ...
    <thead>
      ...
      <tr>
        ...
        <th>Out</th>
        <th>Visitor</th>
        <th><span class="fa fa-edit fa-1x text-info px-3"></span> <span class="fa fa-trash fa-1x text-danger px-3"></span><span class="fa fa-sign-out fa-1x text-success px-3"></span></th>
      </tr>
      </thead>
      ...
      <?php foreach($employees as $employee): ?>
          ...
          <td>
            <a href="index.php?edit=<?php echo ($employee['employee_id'] . '&visit=' . $employee['isVisitor'])?>" id="edit_link" class="btn btn-info btn-sm" >Edit</a>
            <a href="process.php?delete=<?php echo $employee['employee_id']; ?>" class="btn btn-danger btn-sm">Delete</a>

            <?php if (($employee['checkout']==null)): ?>
            <a href="process.php?checkout=<?php echo $employee['employee_id']; ?>" class="btn btn-success btn-sm">Checkout</a>
            <?php endif ?>
          </td>
        </tr>
...
<?php echo  '<script> var fromDate ="' . $myFromDate . '"; var toDate ="' . $myToDate . '"; var myLocation = "' . $location .'";</script>'; ?>
